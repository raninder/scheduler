...
storiesOf("InterviewerListItem", module)
  ...
  .add("Clickable", () => (
    <InterviewerListItem
      ...
      //setInterviewer updated as now it expects a function with no parameters since the id is already passed in InterviewerList
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="4pm"
        interview={{ student: "Lydia Miller-Jones", interviewer: { id: 1, name: "Sylvia Palmer", avatar: "https://i.imgur.com/LpaY82x.png" } }}
      />
      <Appointment time="5pm" />
    </Fragment>
  ))